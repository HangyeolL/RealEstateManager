...
//                    val realEstatePhotoList =
//                        gson.fromJson<List<RealEstatePhoto>>(json = realEstatePhotoAsJson)
//
...
//                            "Gson can't parse objects : $realEstateEntitiesAsJson , $agentEntitiesAsJson"
//                        )
//                        Result.failure()
//                    }
//
