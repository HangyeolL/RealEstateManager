...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        public const val DATABASE_NAME = "RealEstateManager_database"
    }
...
//                    val realEstateEntitiesAsJson = gson.toJson(getRealEstateList())
////                    val realEstatePhotosWithJson = gson.toJson(getRealEstatePhotoLists())
//
//                    workManager.enqueue(
...
////                                    DatabaseInitializationWorker.REAL_ESTATE_PHOTOS_INPUT_DATA to realEstatePhotosWithJson,
//                                )
//                            )
//                            .build()
//                    )
...
//        }
        ...
        private fun getRealEstateList(): List<RealEstateEntity> =
            listOf(
                RealEstateEntity(
                    type = "Studio",
        ...
        private fun getRealEstatePhotoLists(): List<RealEstatePhoto> {
            val photoList = ArrayList<RealEstatePhoto>()
            photoList.addAll(getRealEstatePhotoListOfId1())
            photoList.addAll(getRealEstatePhotoListOfId2())
            photoList.addAll(getRealEstatePhotoListOfId3())
            photoList.addAll(getRealEstatePhotoListOfId4())
            photoList.addAll(getRealEstatePhotoListOfId5())
        ...
        private fun getRealEstatePhotoListOfId5(): List<RealEstatePhoto> =
            listOf(
                RealEstatePhoto(
                    realEstateIdOfPhoto = 5,
                    url = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSyw3BJG0EPlz8xqCgcXY-bLJ76Zu1u3sFGOA&usqp=CAU"
                ),
                RealEstatePhoto(
                    realEstateIdOfPhoto = 5,
                    url = ""
