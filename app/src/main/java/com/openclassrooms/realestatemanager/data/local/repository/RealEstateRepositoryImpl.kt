...
class RealEstateRepositoryImpl @Inject constructor(
    ...
    override fun getRealEstateById(realEstateId: Int): Flow<RealEstateWithPhotos> =
        realEstateDao.getRealEstateById(realEstateId)

    override fun getRealEstatesWithPhotos(): Flow<List<RealEstateWithPhotos>> =
        realEstateDao.getRealEstatesWithPhotos()

    override fun updateRealEstateIdOfPhotoEntity(
        autoGeneratedPhotoId: Long,
        realEstateEntityId: Int
    ) = realEstateDao.updateRealEstatePhotoId(autoGeneratedPhotoId, realEstateEntityId)
}